...
from fairseq.lora_utils import linear_forward_hook, linear_backward_hook
...
class RobertaModel(FairseqLanguageModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--k', default=1, type=int, help='reduced representation dimension')
...
def base_architecture(args):
    ...
    # new added args for the low-rank decomposition
    args.k = getattr(args, 'k', 16)
