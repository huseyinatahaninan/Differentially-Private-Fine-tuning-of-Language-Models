...
from fairseq.compactor_utils import process_batch_grad
...
class Trainer(object):
    ...
    def _build_optimizer(self):
        ...
        for p in self.model.named_parameters():
            if('left' in p[0] or 'right' in p[0] or 'sentence_classification_head' in p[0]):  # only update these parameters
                params.append(p[1])
