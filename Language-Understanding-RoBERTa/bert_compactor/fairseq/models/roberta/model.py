...
from fairseq.compactor_utils import linear_forward_hook, linear_backward_hook
...
class RobertaModel(FairseqLanguageModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--n', default=4, type=int, help='number of kron products')
        parser.add_argument('--k', default=96, type=int, help='dim of adapter layers')
        parser.add_argument('--rank', default=1, type=int, help='rank of low-rank reparametrization')
